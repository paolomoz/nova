...
export function enableMockMode() {
  ...
  Object.assign(api, {
    ...
    getPageSource: () => mock({ content: '<body><header></header><main><div><h1>Welcome to WKND</h1><p>Your adventure starts here. Discover trails, gear, and stories from fellow adventurers.</p></div><div class="hero"><div><div><picture><img src="/media/hero-mountains.jpg" alt="Mountains"></picture></div><div><h2>Adventure Awaits</h2><p>Explore the world with WKND</p><p><a href="/en/products">Shop Gear</a></p></div></div></div><div class="cards"><div><div><h3>Trail Guide</h3><p>Expert-curated hiking routes</p></div></div><div><div><h3>Gear Reviews</h3><p>Honest reviews from the field</p></div></div><div><div><h3>Community</h3><p>Connect with adventurers</p></div></div></div></main><footer></footer></body>', contentType: 'text/html' }),
