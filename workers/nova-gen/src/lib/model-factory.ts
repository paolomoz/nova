...
export class ModelFactory {
  ...
  async call(role: ModelRole, messages: Message[], env: ModelEnv): Promise<ModelResponse> {
  ...
  private async callAnthropic(config: ModelConfig, messages: Message[], apiKey: string): Promise<ModelResponse> {
  ...
  private async callCerebras(config: ModelConfig, messages: Message[], apiKey: string): Promise<ModelResponse> {
